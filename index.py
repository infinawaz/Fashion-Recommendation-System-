...
zip_file_path = '/content/women-fashion.zip'  # Update this path to the correct location of your ZIP file
extraction_directory = '/content/women_fashion'  # Update the extraction path as needed
...
# List and print the first 10 extracted files
